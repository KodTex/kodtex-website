...
export const products: Product[] = [
  ...
  },
  {
    ...
    images: ["/images/fabrics/corduroy/8-wale-wide-corduroy.jpg"],
    featured: true,
    inStock: true,
  ...
  },
  {
    ...
    images: ["/images/fabrics/corduroy/21-wale-fine-corduroy.jpg"],
    featured: false,
    inStock: true,
  ...
  },
  {
    ...
    images: ["/images/fabrics/corduroy/stretch-corduroy-lycra.jpg"],
    featured: true,
    inStock: true,
  ...
  },
  {
    ...
    images: ["/images/fabrics/corduroy/indigo-yarn-dyed-corduroy.jpg"],
    featured: true,
    inStock: true,
  ...
  // LINEN
  {
    ...
    images: ["/images/fabrics/linen/pure-linen-shirting.jpg"],
    featured: true,
    inStock: true,
  ...
  },
  {
    ...
    images: ["/images/fabrics/linen/linen-cotton-blend.jpg"],
    featured: true,
    inStock: true,
  ...
  },
  {
    ...
    images: ["/images/fabrics/linen/heavy-linen-suiting.jpg"],
    featured: false,
    inStock: true,
  ...
  // TWILL
  {
    ...
    images: ["/images/fabrics/twill/cotton-twill-chino.jpg"],
    featured: true,
    inStock: true,
  ...
  // SHIRTING
  {
    ...
    images: ["/images/fabrics/shirting/dobby-weave-shirting.jpg"],
    featured: true,
    inStock: true,
  ...
  // FURNISHING
  {
    ...
    images: ["/images/fabrics/furnishing/corduroy-furnishing-fabric.jpg"],
    featured: true,
    inStock: true,
