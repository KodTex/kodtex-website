...
export function WhatsAppInline({
  ...
  return (
    <a
      ...
      rel="noopener noreferrer"
      className={cn(
        "inline-flex items-center gap-2 bg-[#25D366] text-white px-5 py-2.5 text-sm font-semibold tracking-wide transition-all hover:bg-[#1ebe59] rounded-sm",
        className
      )}
    >
      <WhatsAppIcon size={16} />
